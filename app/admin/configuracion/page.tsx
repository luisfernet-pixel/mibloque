...
async function guardarConfiguracion(formData: FormData) {
  ...
  const cuotaMensual = Number(formData.get("cuota_mensual") || 0);
  const diaVencimiento = Number(formData.get("dia_vencimiento") || 15);
  const valorMora = Number(formData.get("valor_mora") || 0);
  ...
  if (existente?.id) {
    ...
    await supabase.from("configuracion_bloque").insert({
        ...
        <div className="grid gap-6 p-6 md:p-8 xl:grid-cols-[1.15fr_0.85fr]">
          <div className="rounded-[28px] bg-gradient-to-br from-[#031a38] via-[#032247] to-[#0a2f4b] p-6 shadow-2xl ring-1 ring-white/10 md:p-8">
            ...
            <p className="mt-4 max-w-2xl text-base leading-7 text-slate-200 md:text-lg">
              Define cuota mensual, vencimiento y mora del bloque. Mantén la
              operación clara y ordenada.
            </p>
          </div>
          ...
          <div className="rounded-[28px] border border-white/15 bg-[#2f4b6c] p-5 md:p-6">
            ...
            <div className="mt-5 space-y-3">
              ...
              <TipBox text="Las cuotas antiguas mantienen su valor histórico." />
          ...
          <form action={guardarConfiguracion} className="space-y-5">
            ...
            <div className="rounded-2xl bg-[#2d4a6c] p-4 ring-1 ring-white/10">
              ...
              <p className="mt-2 text-sm text-slate-300">
                La cuota puede pagarse hasta el día configurado. Después de esa
                fecha se suma la mora mensual.
              </p>
            </div>
