...
export default async function GastosPage({
  ...
  return (
    <main className="space-y-3">
      ...
      <section className="overflow-hidden rounded-[24px] bg-[#213b59] shadow-xl ring-1 ring-white/10">
        <div className="flex flex-col gap-3 border-b border-white/10 px-3 py-3 md:flex-row md:items-center md:justify-between md:px-4">
          <div>
          ...
          <div className="space-y-2.5 p-2.5 md:p-3">
            {Array.from(mesesAgrupados.values()).map((grupo) => {
              ...
              return (
                ...
                >
                  <summary className="flex flex-col items-start gap-2 px-3 py-2 sm:flex-row sm:items-center sm:justify-between">
                  ...
                  <div className="flex flex-col items-start gap-1.5 border-t border-white/10 px-3 py-2 sm:items-end">
                  ...
                  <div className="space-y-2 border-t border-white/10 px-3 py-2">
                    ...
                    <form action={editarGasto} className="space-y-3.5">
                      ...
                      <div className="flex flex-col gap-2 border-t border-white/10 pt-4 sm:flex-row sm:flex-wrap sm:justify-end sm:gap-3">
                        <a
                          href="/admin/gastos"
                        ...
                        >
                          Guardar cambios
                            ...
                            <div className="grid gap-2 xl:grid-cols-[110px_130px_2fr_140px_auto] xl:items-center">
