  ...
  return (
    <main className="space-y-3">
      ...
      <section className="overflow-hidden rounded-[24px] bg-[#213b59] shadow-xl ring-1 ring-white/10">
        <div className="grid gap-3 p-4 md:p-4 xl:grid-cols-[1.1fr_0.9fr]">
          <div className="rounded-[28px] bg-gradient-to-br from-[#031a38] via-[#032247] to-[#0a2f4b] p-6 shadow-2xl ring-1 ring-white/10 md:p-8">
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              <button
                type="button"
                disabled
                className="cursor-not-allowed rounded-2xl bg-cyan-500/70 px-3.5 py-2 text-sm font-bold text-white"
              >
                Registrar pago
              </button>
              <button
                type="button"
                disabled
                className="cursor-not-allowed rounded-2xl bg-[#ff5a3d]/70 px-3.5 py-2 text-sm font-bold text-white"
              >
              ...
              <button
                type="button"
                disabled
                className="cursor-not-allowed rounded-2xl border border-cyan-400/20 bg-cyan-500/10 px-3.5 py-2 text-sm font-bold text-cyan-200"
              >
                Gestionar cobros
              </button>
              <button
                type="button"
                disabled
                className="cursor-not-allowed rounded-2xl border border-white/10 bg-white/5 px-3.5 py-2 text-sm font-bold text-slate-300"
              >
                Ver gastos
              </button>
            </div>
      ...
      <section className="grid gap-3 md:grid-cols-2 xl:grid-cols-4">
        {kpis.map((item) => (
          <article key={item.title} className="rounded-[24px] bg-[#213b59] p-4 shadow-xl ring-1 ring-white/10">
